...
using Moq;
using IServiceCollectionExtensions = Hirameku.Registration.IServiceCollectionExtensions;
...
public class IServiceCollectionExtensionsTests
{
    ...
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_ConfigurationIsNull_Throws()
    {
        var mockInstance = new Mock<IServiceCollection>();

        _ = IServiceCollectionExtensions.AddRegistrationConfiguration(mockInstance.Object, null!);
    ...
    [TestMethod]
    [TestCategory(TestCategories.Unit)]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_DatabaseOptions()
    {
        var mockConfiguration = GetMockConfiguration();
        var target = new ServiceCollection();

        _ = target.AddRegistrationConfiguration(mockConfiguration.Object);
    ...
    [TestMethod]
    [TestCategory(TestCategories.Unit)]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_EmailerOptions()
    {
        var mockConfiguration = GetMockConfiguration();
        var target = new ServiceCollection();
    ...
    [TestCategory(TestCategories.Unit)]
    [ExpectedException(typeof(ArgumentNullException))]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_InstanceIsNull_Throws()
    {
        var mockConfiguration = new Mock<IConfiguration>();

        _ = IServiceCollectionExtensions.AddRegistrationConfiguration(null!, mockConfiguration.Object);
    ...
    [TestMethod]
    [TestCategory(TestCategories.Unit)]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_PasswordOptions()
    {
        var mockConfiguration = GetMockConfiguration();
        var target = new ServiceCollection();
    ...
    [TestMethod]
    [TestCategory(TestCategories.Unit)]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_PasswordValidatorOptions()
    {
        var mockConfiguration = GetMockConfiguration();
        var target = new ServiceCollection();
    ...
    [TestMethod]
    [TestCategory(TestCategories.Unit)]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_PersistentTokenOptions()
    {
        var mockConfiguration = GetMockConfiguration();
        var target = new ServiceCollection();
    ...
    [TestMethod]
    [TestCategory(TestCategories.Unit)]
    public void IServiceCollectionExtensions_AddRegistrationConfiguration_VerificationOptions()
    {
        var mockConfiguration = GetMockConfiguration();
        var target = new ServiceCollection();
