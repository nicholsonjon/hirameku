...
public class ExceptionsProfile : Profile
{
    public ExceptionsProfile()
    {
        ...
        _ = this.CreateMap<EmailAddressAlreadyVerifiedException, ProblemDetails>()
            .ForMember(d => d.Detail, o => o.MapFrom(s => s.Message))
            .ForMember(d => d.Extensions, o => o.Ignore())
            .ForMember(d => d.Instance, o => o.MapFrom(_ => ErrorCodes.EmailAddressAlreadyVerified))
            .ForMember(d => d.Status, o => o.MapFrom(_ => HttpStatusCode.BadRequest))
            .ForMember(d => d.Title, o => o.MapFrom(_ => Resources.EmailAddressAlreadyVerified));
        ...
        _ = this.CreateMap<UserAlreadyExistsException, ProblemDetails>()
            .ForMember(d => d.Detail, o => o.MapFrom(s => s.Message))
            .ForMember(d => d.Extensions, o => o.Ignore())
            .ForMember(d => d.Instance, o => o.MapFrom(_ => ErrorCodes.UserAlreadyExists))
            .ForMember(d => d.Status, o => o.MapFrom(_ => HttpStatusCode.BadRequest))
            .ForMember(d => d.Title, o => o.MapFrom(_ => Resources.UserAlreadyExists));
