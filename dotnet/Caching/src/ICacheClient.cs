...
public interface ICacheClient
{
    ...
    public Task<CooldownStatus> GetCooldownStatus(string key, TimeSpan timeToLive, CancellationToken cancellationToken = default);

    public Task<long> IncrementCounter(string key, CancellationToken cancellationToken = default);

    public Task<long> IncrementCounter(string key, TimeSpan timeToLive, CancellationToken cancellationToken = default);

    public Task SetValue(string key, string value, CancellationToken cancellationToken = default);

    public Task SetValue(string key, string value, TimeSpan timeToLive, CancellationToken cancellationToken = default);
}
