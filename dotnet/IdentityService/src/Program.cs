...
internal sealed class Program
{
    ...
    private static void ConfigureHost(WebApplicationBuilder builder)
    {
        _ = builder.Host.UseServiceProviderFactory(new AutofacServiceProviderFactory())
            .ConfigureContainer<ContainerBuilder>(cb => cb.RegisterModule<IdentityServiceModule>());
    }
    ...
    private static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        _ = services.AddAuthenticationConfiguration(configuration);
        _ = services.AddRegistrationConfiguration(configuration);
        _ = services.AddUserConfiguration(configuration);
